            ...
            <li class="nav-item w-100">
                <a href="{{route('admin.genre.index')}}"
                   class="nav-link px-0 align-middle {{str_contains(url()->current(), 'genres') ? 'active' : ''}}">
                    <i class="fs-4 fas fa-solid fa-guitar"></i> <span class="ms-1 d-none d-sm-inline">{{__('Genres')}}</span> </a>
            </li>

            <li class="nav-item w-100">
                <a href="{{route('admin.tag.index')}}"
                   class="nav-link px-0 align-middle {{str_contains(url()->current(), 'tags') ? 'active' : ''}}">
                    <i class="fs-4 fas fa-solid fa-tag"></i> <span class="ms-1 d-none d-sm-inline">{{__('Tags')}}</span></a>
            </li>
            <li class="nav-item w-100">
            ...
            <li class="nav-item w-100">
                <a href="{{route('admin.role.index')}}"
                   class="nav-link px-0 align-middle {{str_contains(url()->current(), 'roles') ? 'active' : ''}}">
                    <i class="fs-4 fas fa-solid fa-pen-ruler"></i> <span class="ms-1 d-none d-sm-inline">{{__('Roles')}}</span>
                </a>
            </li>
            <li class="nav-item w-100">
